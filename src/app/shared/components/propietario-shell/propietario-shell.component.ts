    ...
    <div class="app-container">
        ...
        <div class="topbar-content">
          <div class="topbar-left">
            ...
            <nav class="desktop-nav">
              <a routerLink="/propietario/dashboard" routerLinkActive="active" class="nav-link">
                <i class="fas fa-chart-pie"></i> Dashboard
              </a>
              <a routerLink="/propietario/propiedades" routerLinkActive="active" class="nav-link">
                <i class="fas fa-building"></i> Mis Propiedades
              </a>
              <a routerLink="/propietario/solicitudes" routerLinkActive="active" class="nav-link">
          ...
          <div class="topbar-right">
            ...
            <div class="user-menu">
              ...
              <div class="user-dropdown" [class.show]="userMenuOpen()">
                <a routerLink="/propietario/perfil" class="dropdown-item" (click)="userMenuOpen.set(false)">
      ...
      <div class="mobile-menu" [class.show]="sidebarOpen()">
        ...
        <div class="mobile-menu-content">
          <nav>
            <a routerLink="/propietario/dashboard" routerLinkActive="active" class="nav-link" (click)="closeSidebar()">
              <i class="fas fa-chart-pie"></i> Dashboard
            </a>
            <a routerLink="/propietario/propiedades" routerLinkActive="active" class="nav-link" (click)="closeSidebar()">
              <i class="fas fa-building"></i> Mis Propiedades
            </a>
            <a routerLink="/propietario/solicitudes" routerLinkActive="active" class="nav-link" (click)="closeSidebar()">
              <i class="fas fa-inbox"></i> Solicitudes
              @if (pendingRequests() > 0) {
                <span class="badge">{{ pendingRequests() }}</span>
              }
