  ...
  styles: [`
    ...
    .conversation-item {
      ...
      &.unread { background: #f0fdf4;
        .conversation-info strong { color: #1f2937; }
      }
    ...
    .empty-conversations {
      ...
      justify-content: center; padding: 3rem; color: #9ca3af;
    ...
    .message {
      ...
      &.own {
        ...
        .message-content { background: #10b981; color: white;
    ...
    .chat-input {
      ...
      .send-btn {
        width: 44px; height: 44px; border: none; background: #10b981;
